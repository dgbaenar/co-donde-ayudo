...
- Route backend implementation to `backend-developer`, frontend implementation to
  `frontend-developer`, read-only checks to `local-verifier`, structural review to
  `python-architect`, supplied-document review to `document-reviewer`, and independent evidence and
  scope review to `integrity-auditor`.
